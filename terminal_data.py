...
#plt.show()
df2.nlargest((int(len(df2["hadzanie"])/3)), "hadzanie", keep="all").to_csv('kia40_dataframe5zle.csv', mode='a', index = False, header=True)
#df2.to_csv ('kia40_dataframe5zle.csv', mode='a', index = False, header=True)
print(df2)
